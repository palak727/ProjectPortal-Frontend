...
function ProjectDetails() {
  ...
  return (
    <div className="p-4">
      <DefaultLayout>
        <div className="flex justify-between"><h1 className="mb-4 text-2xl font-bold">{project.title}</h1>
        <button
            className="bg-green-500 w-50 mb-4 text-white rounded-md px-4 py-2 hover:bg-green-600 transition duration-300 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-50"
